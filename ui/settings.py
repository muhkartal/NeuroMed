...
def render_settings() -> None:
    ...
    with tabs[0]:
        _render_profile_settings(user_manager)

    with tabs[1]:
        _render_api_settings(openai_client)

    with tabs[2]:
        _render_preferences()

    with tabs[3]:
        _render_data_management(user_manager)

def _render_profile_settings(user_manager) -> None:
    """
    ...
    try:
        ...
        _render_profile_list_editor(user_manager, "allergies", "Allergy")

        # Chronic conditions
        st.subheader("Chronic Conditions")
        _render_profile_list_editor(user_manager, "chronic_conditions", "Chronic Condition")

        # Medications
        st.subheader("Medications")
        _render_profile_list_editor(user_manager, "medications", "Medication")
...
def _render_profile_list_editor(user_manager, list_name, item_label) -> None:
    """
...
def _render_api_settings(openai_client) -> None:
    """
...
def _render_data_management(user_manager) -> None:
    """
